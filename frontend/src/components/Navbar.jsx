    ...
    return (
        <div className='flex items-center justify-between py-0 font-medium'>
            ...
            <div className='flex items-center gap-8'>
                ...
                <Link Ito='/cart' className='relative'>
                    <img src={assets.cart_icon} className='w-5 min-w-5' alt="" />
                    <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-red-500 text-white aspect-aquare rounded-full text-[8px]'>10</p>
                </Link>
