    ...
    <div class="px-3 py-1 bg-black border-bottom">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <a href="Home" class="d-flex justify-content-start my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
          ...
          <ul class="nav col-12 col-lg-6 my-2 justify-content-center my-md-0 text-small">
            <li>
              <a href="Home" onClick={() => Navigate("/Home")} class="nav-link text-secondary">
                Home
              </a>
            </li>
            <li>
